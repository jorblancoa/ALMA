...
#define MyAppName "Alma Core"
#define MyAppPublisher "2022 DECENOMY Core Developers"
#define MyAppURL "https://alma.com"
#define MyAppExeName "alma-qt.exe"
#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/ALMA/bootstrap.zip"
...
[Files]
Source: ".\package\alma-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Alma\Alma-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Alma\Alma-Qt,strDataDir|{userappdata}\Alma\}');
  Result := True;
end;
