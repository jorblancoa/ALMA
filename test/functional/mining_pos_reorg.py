...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected ALMA supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check ALMA supply at the beginning
        # ------------------------------------------
        # ALMA supply: block rewards minus burned fees for minting
        ...
        # Verify that ALMA supplies were properly updated after the spends and reorgs
        self.log.info("Check ALMA supply...")
