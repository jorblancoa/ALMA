...
"""Verify that starting alma with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start alma with -? for help text")
        ...
        self.log.info("Start alma with -version for version information")
