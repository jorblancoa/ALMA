...
/* Alma GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Alma"
#define QAPP_ORG_DOMAIN "alma.org"
#define QAPP_APP_NAME_DEFAULT "Alma-Qt"
#define QAPP_APP_NAME_TESTNET "Alma-Qt-testnet"
