Contributing to Alma Core
============================

The Alma Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Alma Core project, and is not to be
confused with overall Alma Network Protocol consensus changes.

Whether a pull request is merged into Alma Core rests with the project merge
...
Patches that change Alma consensus rules are considerably more involved than
...
Where a patchset proposes to change the Alma consensus, it must have been
...
The project leader is the release manager for each Alma Core release.
